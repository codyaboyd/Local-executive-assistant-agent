...
class Settings(BaseSettings):
    ...
    web_enabled: bool = Field(default=True, validation_alias="EXEC_AGENT_WEB_ENABLED")
    web_host: str = Field(default="0.0.0.0", validation_alias="EXEC_AGENT_WEB_HOST")
    web_port: int = Field(default=8080, ge=1, le=65535, validation_alias="EXEC_AGENT_WEB_PORT")
    web_password_hash: str = Field(default="", validation_alias="EXEC_AGENT_WEB_PASSWORD_HASH")
    web_session_secret: str = Field(default="", validation_alias="EXEC_AGENT_WEB_SESSION_SECRET")
    web_session_timeout_minutes: int = Field(default=720, ge=1, validation_alias="EXEC_AGENT_WEB_SESSION_TIMEOUT_MINUTES")
    web_reverse_proxy_tls: bool = Field(default=False, validation_alias="EXEC_AGENT_WEB_REVERSE_PROXY_TLS")
    web_cookie_secure: bool = Field(default=False, validation_alias="EXEC_AGENT_WEB_COOKIE_SECURE")
